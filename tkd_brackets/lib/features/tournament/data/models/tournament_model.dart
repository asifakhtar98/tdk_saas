...
class TournamentModel with _$TournamentModel {
  ...
  const factory TournamentModel({
    ...
    @JsonKey(name: 'federation_type') required String federationType, @JsonKey(name: 'status') required String status, @JsonKey(name: 'is_template') required bool isTemplate, @JsonKey(name: 'number_of_rings') required int numberOfRings, @JsonKey(name: 'settings_json') required Map<String, dynamic> settingsJson, @JsonKey(name: 'sync_version') required int syncVersion, @JsonKey(name: 'is_deleted') required bool isDeleted, @JsonKey(name: 'is_demo_data') required bool isDemoData, @JsonKey(name: 'created_at_timestamp') required DateTime createdAtTimestamp, @JsonKey(name: 'updated_at_timestamp') required DateTime updatedAtTimestamp, String? description,
    String? venueName,
    String? venueAddress,
