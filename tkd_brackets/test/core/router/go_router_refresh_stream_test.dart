...
void main() {
  group('GoRouterRefreshStream', () {
    ...
    setUp(() {
      ...
      refreshStream = GoRouterRefreshStream(streamController.stream);
    });
    ...
    test('calls notifyListeners on construction', () {
    ...
    test('calls notifyListeners for each stream event', () async {
      var notifyCount = 0;
      refreshStream.addListener(() => notifyCount++);
