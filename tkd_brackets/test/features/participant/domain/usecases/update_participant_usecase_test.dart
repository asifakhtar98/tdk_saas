  ...
  group('UpdateParticipantUseCase', () {
    group('input validation', () {
      test('returns InputValidationFailure when '
        ...
        const params = UpdateParticipantParams(participantId: '');
      ...
      test('returns InputValidationFailure when '
          'no fields are provided for update', () async {
        const params = UpdateParticipantParams(participantId: 'participant-id');
        final result = await useCase(params);
        expect(result.isLeft(), true);
        result.fold((failure) {
          expect(failure, isA<InputValidationFailure>());
      ...
      test('returns InputValidationFailure when '
          'firstName is empty string', () async {
      ...
      test('returns InputValidationFailure when '
          'lastName is whitespace only', () async {
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          lastName: '   ',
        );
      ...
      test('returns InputValidationFailure when '
          'schoolOrDojangName is empty', () async {
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          schoolOrDojangName: '',
        );
      ...
      test('returns InputValidationFailure when '
          'weightKg exceeds maximum', () async {
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          weightKg: 200,
        );
      ...
      test('returns InputValidationFailure when '
          'dateOfBirth is in the future', () async {
      ...
      test('validates before making any repository calls', () async {
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          firstName: '', // invalid
          weightKg: -1, // invalid
    ...
    group('division status check', () {
      test('returns InputValidationFailure when '
          'division status is inProgress', () async {
        setupSuccessMocks(
          division: tDivision.copyWith(status: DivisionStatus.inProgress),
        );
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          firstName: 'Bob',
      ...
      test('returns InputValidationFailure when '
          'division status is completed', () async {
        setupSuccessMocks(
          division: tDivision.copyWith(status: DivisionStatus.completed),
        );
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          firstName: 'Bob',
      ...
      test('allows update when division status is ready', () async {
        setupSuccessMocks(
          division: tDivision.copyWith(status: DivisionStatus.ready),
        );
        const params = UpdateParticipantParams(
          participantId: 'participant-id',
          firstName: 'Bob',
    ...
    group('successful updates', () {
      ...
      test('should update multiple fields simultaneously', () async {
        ...
        result.fold((_) => fail('Should be Right'), (updated) {
          ...
          expect(updated.dateOfBirth, DateTime(2000, 6, 15));
