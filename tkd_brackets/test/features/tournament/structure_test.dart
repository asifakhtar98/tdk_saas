...
/// Tests that verify the tournament feature structure and Clean Architecture compliance.
///
...
/// ```bash
/// cd tkd_brackets
/// flutter test test/features/tournament/structure_test.dart
/// ```

void main() {
  group('Tournament Feature Structure', () {
    const basePath = 'lib/features/tournament';
    ...
    test('should have barrel file', () {
      expect(
        File('$basePath/tournament.dart').existsSync(),
        isTrue,
    ...
    test('should have tournament list page', () {
      expect(
        File(
          '$basePath/presentation/pages/tournament_list_page.dart',
        ).existsSync(),
        isTrue,
        reason: 'Tournament list page should exist',
      );
    });

    test('barrel file should export tournament list page', () {
      final barrelFile = File('$basePath/tournament.dart');
      ...
      expect(
        ...
        isTrue,
        reason: 'Barrel file should export tournament_list_page.dart',
      );
    });

    group('Clean Architecture Compliance', () {
      test('domain layer should not contain data imports', () {
        // When domain files are added, this test ensures they don't import data layer
        // This is a structural check - actual import validation happens in analysis
