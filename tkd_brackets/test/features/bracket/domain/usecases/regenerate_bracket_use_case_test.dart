...
void main() {
  ...
  group('Validation (no repository or generator calls)', () {
    ...
    test('validation order: empty divisionId checked before participants',
        () async {
  ...
  group('Finalized bracket blocking', () {
    test('single finalized bracket → ValidationFailure with "finalized"',
        () async {
    ...
    test('non-finalized bracket → proceeds to cleanup and regeneration',
        () async {
