...
void main() {
  group('Bracket Feature Structure', () {
    ...
    test('barrel file should have fifty-five export statements', () {
      ...
      expect(
        ...
        55,
        reason:
            'Barrel file should have fifty-five exports for bracket & match entity & repo + services + usecases + presentation',
      );
    });
